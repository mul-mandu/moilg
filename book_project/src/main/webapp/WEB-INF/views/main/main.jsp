	...
	<div class="row">
		<div class="col-4">
			<div class="userPickSTC_item">
				...
				<br />
				<p class="userPickSTC_text">당신의 노력은 절대로 쓸데 없는 일이 되지는 않습니다. 마지막까지
					꼭 믿어주세요. 마지막의 마지막 순간까지 믿어야합니다. - 나미야 잡화점의 기적 中 당신의 노력은 절대로 쓸데 없는 일이
					되지는 않습니다. 마지막까지 꼭 믿어주세요.</p>
				<span>나미야 잡화점의 기적 중</span> <br /> <span>by. user_name</span> <span
		...
		<div class="col-4">
			<div class="userPickSTC_item">
				...
				<span>데미안 中</span> <br /> <span>by. user_name</span> <span
					style="font-weight: bold; color: grey; font-size: 16px; float: right;">
					공감수10 </span>
			</div>
		</div>
		...
		<div class="col-4">
			<div class="userPickSTC_item">
				...
				<span>작자 미상 中</span> <br /> <span>by. user_name</span> <span
					style="font-weight: bold; color: grey; font-size: 16px; float: right;">
					공감수10 </span>
			</div>
		</div>
