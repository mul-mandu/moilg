...
<%@ include file="../includes/header.jsp" %>
                      ...
                      <div>
                           ...
                           <form method="POST" action="/signup/signup">
                              ...
                              <td> <input type="text" name="name" id="nickCheck" placeholder="닉네임 체크" disabled/> </td>
                                 ...
                                 <tr>
                                    <td>* 이메일</td>
                              <td>  <input type="text" name="email" id="email" placeholder="example@email.com" required/> </td>
                                 </tr>
                              ...
                              <br />
                              <br />
                               <button type="button" id="submit" class="form-submit btn btn-primary">가입하기</button>
                           </form>
                        </div>
                    </div>
   ...
   $(document).ready(function(){
		$("#submit").on("click", function(){
				   ...
				   var regExp = /^[0-9a-zA-Z]([-_.]?[0-9a-zA-Z])*@[0-9a-zA-Z]([-_.]?[0-9a-zA-Z])*\.[a-zA-Z]([-_.]?[0-9a-zA-Z]){2,3}$/i;
