        ...
        <div class="row">
           <div class="col-5">
			...
			<div class="col">
				...
				<br />
				<button id="addHashTag" type="button"
					class="btn btn-outline-secondary mx-auto">+ 키워드 추가</button>
...
///////////////////////////
   ...
   function addPLKeyWord(){
     ...
     // console.log("진짜 최종  저장할 키워드 리스트!!! " + keyWordList);
      $.ajax({
         type : "POST",
  ...
  //- ************************************  키워드 스크립트!!!!!!!!!!!!!!!! ******************** 
   ...
   $(".keyWord_btn").on("click", function(){
       ...
       if(keyWordList.length == 10 ){ //키워드 10개 제한하기
		   ...
		   if(keyWordList.includes(clickValue)){
				...
				keyWordList.push(clickValue);
				//console.log("보여줄 키워드 담은거 !!!" + keyWord );
				//console.log("진짜 저장할 키워드 값!!!" + keyWordList );
     ...
     //var copySelecteyKeyword = $("#selectedKeyword").html(keyWord);  //최종 선택한 키워드 복사하기
	      ...
	      //console.log("화면 키워드 삭제 버튼 클릭함!!!");
	       ...
	       for(var i = 0; i < keyWordList.length; i++){
	    	      ...
	    	      //console.log("for문 거친 keyWordList : " + keyWord);
	    	        ...
	    	        //console.log("저장할 keyWordList : " + keyWordList);
	   });
    ...
    $("#selectedKeyword").on("click", "#cancelKey", function(){
       //console.log("키워드 삭제 버튼 클릭함!!!");
        ...
        //console.log("val : " + val);
        //console.log("저장한 keyWordList : " + keyWordList);
       // console.log("삭제할 keyWordList : " + keyWordList[delIndex]);
